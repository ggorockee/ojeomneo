...
class AppTheme {
  ...
  // Primary: 소프트 오렌지 → Secondary: 소프트 옐로우
  static const Color primaryColor = Color(0xFFEF8A5A); // 소프트 오렌지 (연하게)
  static const Color secondaryColor = Color(0xFFF7C56B); // 소프트 옐로우 (연하게)
  static const Color tertiaryColor = Color(0xFFFFAB7A); // 피치 (포인트)
  static const Color errorColor = Color(0xFFE57373); // 소프트 레드

  // Surface Colors (따뜻하고 부드러운 톤)
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: surfaceVariant.withAlpha(128),
