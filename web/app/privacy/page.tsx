    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <h1 id="privacy-policy" className="text-4xl font-bold text-gray-900 mb-8">개인정보처리방침</h1>
          
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-8">
              오점너는 이용자의 개인정보 보호를 매우 중요하게 생각하며, 「개인정보 보호법」 및 관련 법령에 따라 개인정보를 안전하게 처리하고 있습니다.
            </p>
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 p-6 rounded-xl mb-4">
                ...
                <ul className="text-gray-700 space-y-2">
                  <li>• <strong>계정정보</strong>: 이메일 주소 (회원가입 시)</li>
                  <li>• <strong>기기정보</strong>: 기기 식별자 (디바이스 ID), OS 버전, 앱 버전</li>
                  <li>• <strong>스케치 이미지</strong>: 사용자가 업로드한 음식 사진 또는 스케치 이미지</li>
                  <li>• <strong>사용 통계</strong>: 앱 사용 패턴, 메뉴 검색 기록</li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 p-6 rounded-xl">
                ...
                <ul className="text-gray-700 space-y-2">
                  ...
                  <li>• AI 기반 메뉴 추천 서비스 제공</li>
                  <li>• 스케치 이미지 분석 및 메뉴 매칭</li>
            ...
            <section className="mb-8">
              ...
              <div className="bg-yellow-50 p-6 rounded-xl">
                ...
                <ul className="text-gray-700 space-y-2">
                  <li>• <strong>비회원 데이터</strong>: 디바이스 ID와 스케치 이미지는 7일간 보관 후 자동 삭제됩니다.</li>
                  <li>• <strong>회원 계정정보</strong>: 회원 탈퇴 시까지 보관하며, 탈퇴 후 즉시 삭제됩니다.</li>
                  <li>• <strong>스케치 이미지</strong>: 암호화되어 서버에 저장되며, 비회원은 7일, 회원은 탈퇴 시 삭제됩니다.</li>
                  <li>• <strong>법적 의무</strong>: 관련 법령에 따라 일부 정보는 30일간 보관될 수 있습니다.</li>
                  <li>• 수집된 정보는 <strong>HTTPS 암호화 통신</strong>을 통해 안전하게 처리됩니다.</li>
            ...
            <section className="mb-8">
              ...
              <div className="bg-red-50 p-6 rounded-xl">
                ...
                <ul className="text-gray-700 space-y-2">
                  <li>• <strong>OpenAI API</strong>: 스케치 이미지 분석 및 메뉴 추천을 위한 AI 서비스</li>
                  <li>• <strong>Firebase Authentication</strong>: 회원 인증 및 계정 관리</li>
                </ul>
                <p className="text-gray-600 mt-4">
                  위 제3자들은 각각의 개인정보처리방침에 따라 정보를 처리하며,
                  오점너는 이용자의 개인정보를 영리 목적으로 제3자에게 판매하거나 제공하지 않습니다.
                </p>
              </div>
            </section>
            ...
            <section id="account-deletion" className="mb-8">
              ...
              <div className="bg-red-50 p-6 rounded-xl mb-4">
                <h3 className="text-lg font-semibold text-red-900 mb-3">오점너 - 계정 삭제 안내</h3>
            ...
            <section className="mb-8">
              ...
              <div className="bg-indigo-50 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">
                  오점너는 다음과 같은 기술을 사용하여 서비스를 제공합니다:
                </p>
                <ul className="text-gray-700 space-y-2">
                  <li>• <strong>Firebase Authentication</strong>: 회원 인증 및 계정 관리</li>
                  <li>• <strong>OpenAI API</strong>: AI 기반 메뉴 추천 서비스</li>
                </ul>
                <p className="text-gray-600 mt-4">
                  이러한 기술들은 서비스 제공을 위한 최소한의 정보만을 수집하며, 개인을 식별할 수 없는 익명화된 정보만을 수집합니다.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 p-6 rounded-xl">
                ...
                <div className="text-gray-700">
                  <p><strong>서비스명:</strong> 오점너</p>
                  <p><strong>개인정보보호책임자:</strong> 오점너 개발팀</p>
